...
const ViewBook = (props) =>{
    ...
    return (
      ...
      <Paper elevation={4} sx={{marginTop:4, padding:2, marginRight:4, height:600}}>
          <Grid item={true}>  <img src={book.cover} alt="" style={{height:'300px', width:'250px'}} /></Grid>
         <div style={{height:240}}>
         <Grid item={true}>  <Typography variant='h5'>{book.title}</Typography></Grid><Grid item={true} >  <Typography>{book.desc}</Typography></Grid>
         <Grid item={true}>    <Typography><b>Price: ${book.price}</b></Typography></Grid></div>
